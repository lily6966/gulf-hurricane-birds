...
def main(_):
    ...
    os.makedirs("./results/intHigh/", exist_ok=True)  # Ensure output directory exists
    with open("./results/intHigh/predictions_case_%d_month_%d.csv" % (FLAGS.case, FLAGS.mon), "w") as f:
        f.write("LON,LAT,")
