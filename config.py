...
flags.DEFINE_string('checkpoint_path', './model/model.weights.h5','The path to a checkpoint from which to fine-tune.')
...
flags.DEFINE_integer('batch_size', 500, 'the number of data points in one minibatch') #128
flags.DEFINE_integer('testing_size', 500, 'the number of data points in one testing or validation batch') #128
flags.DEFINE_integer('mon', 5, 'the number of data points in one testing or validation batch') #128
flags.DEFINE_integer('case', 500, 'the number of data points in one testing or validation batch') #128
...
flags.DEFINE_integer('r_dim', 332, 'the number of labels in current training') #100
flags.DEFINE_integer('r_max_dim', 332, 'max number of all labels in the dataset')

flags.DEFINE_integer('loc_offset', 2, 'the offset caused by location features') #100
flags.DEFINE_integer('nlcd_dim', 35, 'the dimensionality of the NLCD features ')
